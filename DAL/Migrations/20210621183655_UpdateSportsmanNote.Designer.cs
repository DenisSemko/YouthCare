...
namespace DAL.Migrations
{
    ...
    [Migration("20210621183655_UpdateSportsmanNote")]
    partial class UpdateSportsmanNote
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CIL.Models.Analysis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CIL.Models.ObservationNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CIL.Models.Section", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CIL.Models.SportsmanNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CIL.Models.Treatment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CIL.Models.UsersUsers", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CIL.Models.Analysis", b =>
                {
                    b.HasOne("CIL.Models.User", "DoctorUserId")
                        .WithMany("DoctorAnalyses")
                        .HasForeignKey("DoctorUserIdId");

                    b.HasOne("CIL.Models.User", "SportsmanUserId")
            ...
            modelBuilder.Entity("CIL.Models.Message", b =>
                {
                    b.HasOne("CIL.Models.User", "RecepientId")
                        .WithMany("MessageRecepient")
                        .HasForeignKey("RecepientIdId");

                    b.HasOne("CIL.Models.User", "SenderId")
            ...
            modelBuilder.Entity("CIL.Models.ObservationNote", b =>
                {
                    ...
                    b.HasOne("CIL.Models.Treatment", "Treatment")
                        .WithMany("ObservationNotes")
            ...
            modelBuilder.Entity("CIL.Models.User", b =>
                {
                    b.HasOne("CIL.Models.Section", "BelongSection")
                        .WithMany("UsersList")
